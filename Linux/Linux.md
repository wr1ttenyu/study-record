...
- 常用选项
   ...
   ![grep选项](C:\Users\wr1ttenyu\学习\study-record\Linux\img\grep选项.png)

- 应用实例

  案例 1: 请在  hello.txt  文件中，查找  "yes"    所在行，并且显示行号

  ![grep实例](C:\Users\wr1ttenyu\学习\study-record\Linux\img\grep实例.png)
...
- 选项说明
  ...
  ![tar 选项](C:\Users\wr1ttenyu\学习\study-record\Linux\img\tar 选项.jpg)
...
![创建用户 指定组](C:\Users\wr1ttenyu\学习\study-record\Linux\img\创建用户 指定组.png)
